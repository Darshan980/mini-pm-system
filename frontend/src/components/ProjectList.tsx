...
const ProjectList: React.FC<ProjectListProps> = ({ onSelectProject }) => {
  ...
  const [deleteProject] = useMutation<DeleteProjectResponse>(DELETE_PROJECT, {
    onCompleted: (data: DeleteProjectResponse) => {
  ...
  return (
    <div className="project-list-container">
      ...
      {/* CSS Styles moved to regular CSS or external file */}
    </div>
  );
};
